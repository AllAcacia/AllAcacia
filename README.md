...
## Current Projects
I am currently working on a big project I call "Card-Jitsu Quartet", which is a recreation of one of Club Penguin's series of minigames (before their unfortunate shutdown). The target platform is the Nintendo 3DS, using the **devkitPro-libctru** toolchain! The main repository is private (because of Disney's IP), although I host a public repository for the source code. Through this project I have learnt a lot on how to approach making a game engine (at least on the 3DS), with help via **devkitPro's "3ds-examples"** library.  
## How to Reach Me
